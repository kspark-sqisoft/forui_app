...
const List<GalleryMenuSection> appMenuSections = [
  GalleryMenuSection(
    ...
    categories: [
      GalleryMenuCategory(
        title: '시작',
        items: [GalleryMenuItem(path: '/home', title: '홈', icon: FIcons.house)],
      ),
    ],
  ),
  GalleryMenuSection(
      ...
      GalleryMenuCategory(
        ...
        items: [
          ...
          GalleryMenuItem(
            ...
            title: 'Select · 리빌드 최소화',
            icon: FIcons.crosshair,
          ),
          GalleryMenuItem(
      ...
      GalleryMenuCategory(
        ...
        items: [
          GalleryMenuItem(
            path: '/form/button',
            title: 'Button',
            icon: FIcons.squareMousePointer,
          ),
          GalleryMenuItem(
          ...
          GalleryMenuItem(
            path: '/form/picker',
            title: 'Picker',
            icon: FIcons.gripVertical,
          ),
          GalleryMenuItem(
            path: '/form/autocomplete',
            title: 'Autocomplete',
            icon: FIcons.textSearch,
          ),
        ],
      ),
      GalleryMenuCategory(
      ...
      GalleryMenuCategory(
        ...
        items: [
          ...
          GalleryMenuItem(
            ...
            icon: FIcons.listChevronsUpDown,
          ),
        ],
      ),
      GalleryMenuCategory(
        ...
        items: [
          ...
          GalleryMenuItem(
            ...
            title: 'Pagination',
            icon: FIcons.chevronsLeftRight,
          ),
          GalleryMenuItem(
            path: '/navigation/header',
            title: 'Header',
            icon: FIcons.panelTop,
          ),
          GalleryMenuItem(
            path: '/navigation/bottom-nav',
            title: 'Bottom nav',
            icon: FIcons.panelBottom,
          ),
        ],
      ),
      GalleryMenuCategory(
